...
api_id = int(os.getenv("API_ID", "29418823"))
api_hash = os.getenv("API_HASH", "a72c7c0d4a19d7e512ae759521cc17d8")
bot_token = os.getenv("BOT_TOKEN", "6288136921:AAGmTgBH6tWQc3doks6f6gBeu3wdDGJ3fv0")
  ...
  await event.reply(cap, 
             buttons=(
                       [
                        ...
                        Button.url('🐊 Sahip', 'https://t.me/BayTimsah')
                       ]
                      )
                     )
